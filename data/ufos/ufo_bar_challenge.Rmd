...
<p class="note">Want to add labels to your graphs? Use `labs()` with `title`, `subtitle`, `caption`, `x` and `y`.</p>
...
**Hint**: `?facet_wrap()`; (`theme(legend.position = "none")`)[https://www.datanovia.com/en/blog/how-to-remove-legend-from-a-ggplot/#ggplot-with-no-legend]{target="_blank"}
